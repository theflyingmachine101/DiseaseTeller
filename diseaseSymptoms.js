module.exports={
    "Influenza":["body aches","chills","dry cough","fatigue","headache","high fever (>100.4 F)","increased sweating","nasal congestion","sore throat"],
    "Common Cold":["cough","fatigue","low fever (<100.4 F)","nasal congestion","runny nose","sneezing","sore throat"],
    "Pneumonia":["chest pain while breathing","chills","confusion (elders)","cough with phlegm","diarrhea","fatigue","high fever (>100.4 F)","increased sweating","lower than normal body temp (elders)","nausea","shaking","shortness of breath","vomiting"],
    ...
    "Panic Attacks":["abdominal pain","chest pain","chills","difficulty breathing","fear of loss","headache","increased sweating","nausea","numbness","rapid heart rate","sense of danger","shaking"],
    ...
    "Insomnia":["anxiety","daytime tiredness or sleepiness","diarrhea","depression","difficulty falling asleep at night","inability to concentrate and focus","increased erros or accidents","not feeling well-rested after night's sleep","waking up during night","waking up too early"],
